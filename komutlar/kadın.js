...
if(!['783345825345568788'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '794289929030336523')
...
• **Kullanıcının yeni ismi :${tag} ${name} | ${age}**
